...
public class Window extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        search_jTextField.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        xlsExport_jButton1.setText("Export to Excel");
        xlsExport_jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                xlsExport_jButton1ActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(search_jTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 322, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 610, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(xlsExport_jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(xlsExport_jButton1))
                .addGap(19, 19, 19))
        );
    ...
    private void search_jTextFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_search_jTextFieldKeyReleased
        DefaultTableModel currentTableModel = (DefaultTableModel) clubs_jTable.getModel();
        TableRowSorter<DefaultTableModel> currentTableSorter = new TableRowSorter<>(currentTableModel);
        clubs_jTable.setRowSorter(currentTableSorter);
        
        String searchText = search_jTextField.getText();
        
        currentTableSorter.setRowFilter(RowFilter.regexFilter(searchText));
    }//GEN-LAST:event_search_jTextFieldKeyReleased

    private void xlsExport_jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_xlsExport_jButton1ActionPerformed
        String exportDirectory = "C:\\Users\\eimwe\\Documents\\NetBeansProjects\\student-clubs\\exports\\";
        String filePath = exportDirectory + "exported_student_clubs.xlsx";
        
        ExcelExporter.exportToExcel(clubs_jTable, filePath);
    }//GEN-LAST:event_xlsExport_jButton1ActionPerformed
    ...
    private javax.swing.JButton xlsExport_jButton1;
